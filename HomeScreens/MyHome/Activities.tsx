...
const Activities = () => {
  return (
    <View>
    <Text style={{marginHorizontal:30,marginTop:10,marginBottom:5,fontFamily:'Poppins-Regular',fontSize:17}}>Introduction</Text>
    <View style={{flexDirection:'row'}}>
        <LinearGradient
          colors={['rgba(195, 195, 238, 0.76) @ 8.68%','rgba(177, 177, 236, 0.52) @ 38.89%','rgba(201, 201, 229, 0.32) @ 99.99%','rgba(255, 255, 255, 7) @ 100%']} style={styles.cardImagecontainer}>
              ...
              <Text style={{ fontSize: 14, color:"#000", fontFamily:'Poppins-Regular',alignSelf:'center',marginVertical:5}}>What is CBT</Text>    
              </TouchableOpacity> 
        </LinearGradient>   
        <LinearGradient
          colors={['rgba(195, 195, 238, 0.76) @ 8.68%','rgba(177, 177, 236, 0.52) @ 38.89%','rgba(201, 201, 229, 0.32) @ 99.99%','rgba(255, 255, 255, 7) @ 100%']} style={styles.cardImagecontainer}>
              ...
              <TouchableOpacity onPress={()=>{}}>
              <Text style={{ fontSize: 14, color:"#000", fontFamily:'Poppins-Regular',alignSelf:'center',marginVertical:5}}>What is it</Text>    
              </TouchableOpacity>                                
                                      
        </LinearGradient> 
    </View>  
    <View>
    <Text style={{marginHorizontal:30,marginTop:10,marginBottom:5,fontFamily:'Poppins-Regular',fontSize:17}}>Congnitive Disortion</Text>
    <View style={{flexDirection:'row'}}>
        <LinearGradient
          colors={['rgba(195, 195, 238, 0.76) @ 8.68%','rgba(177, 177, 236, 0.52) @ 38.89%','rgba(201, 201, 229, 0.32) @ 99.99%','rgba(255, 255, 255, 7) @ 100%']} style={styles.cardImagecontainer}>
        ...
        <LinearGradient
          colors={['rgba(195, 195, 238, 0.76) @ 8.68%','rgba(177, 177, 236, 0.52) @ 38.89%','rgba(201, 201, 229, 0.32) @ 99.99%','rgba(255, 255, 255, 7) @ 100%']} style={styles.cardImagecontainer}>
              ...
              <TouchableOpacity onPress={()=>{}}>
              <Text style={{ fontSize: 14, color:"#000", fontFamily:'Poppins-Regular',alignSelf:'center',marginVertical:5}}>Types</Text>    
              </TouchableOpacity>                                
