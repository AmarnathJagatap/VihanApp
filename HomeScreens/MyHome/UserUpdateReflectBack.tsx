   ...
   style={styles.container}
    ...
    <ScrollView style={{
        flex:1,
         ...
         nestedScrollEnabled = {true}>
        <View>
        <Text style={{marginHorizontal:30,marginTop:10,marginBottom:5,fontFamily:'Poppins-Regular',fontSize:13}}>Add Note</Text>
      ...
      <ScrollView style={styles.container1}>  
              <Text style={{marginHorizontal:30,marginTop:10,marginBottom:5,fontFamily:'Poppins-Bold',fontSize:13}}>Doctor Note</Text>
              <TouchableOpacity>
                                  <Text style={{marginHorizontal:30,marginTop:10,marginBottom:5,fontFamily:'Poppins-Regular',fontSize:13}}>{reflectBack.title}</Text>
