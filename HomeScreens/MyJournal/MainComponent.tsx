  ...
  return (
    ...
    <View>
      ...
      <View style={{flexDirection:'row',justifyContent:'space-evenly',marginVertical:10}}>
        ...
        <Text style={{ fontSize: 15,color:"rgba(0, 0, 0, 0.40)",fontFamily:'Poppins-Regular',marginVertical:5}}>28th Oct</Text>        
        <TouchableOpacity>
      ...
      <View style={{flexDirection:'row',justifyContent:'space-evenly',marginVertical:10}}>
        ...
        <Text style={{ fontSize: 15,color:"rgba(0, 0, 0, 0.40)",fontFamily:'Poppins-Regular',marginVertical:5}}>22th Nov</Text>        
        <TouchableOpacity>
          <FontAwesome name="chevron-right" size={20} color={'rgba(0, 0, 0, 0.60)'} style={{justifyContent:'center',alignItems:'center',marginVertical:8,marginRight:8}}/>
        </TouchableOpacity>                    
      ...
      <View style={{flexDirection:'row',justifyContent:'space-evenly',marginVertical:10}}>
        ...
        <Text style={{ fontSize: 15,color:"rgba(0, 0, 0, 0.40)",fontFamily:'Poppins-Regular',marginVertical:5}}>30th Nov</Text>        
        <TouchableOpacity>
          <FontAwesome name="chevron-right" size={20} color={'rgba(0, 0, 0, 0.60)'} style={{justifyContent:'center',alignItems:'center',marginVertical:8,marginRight:8}}/>
        </TouchableOpacity>                    
      ...
      <View style={{flexDirection:'row',justifyContent:'space-evenly',marginVertical:10}}>
        ...
        <Text style={{ fontSize: 15,color:"rgba(0, 0, 0, 0.40)",fontFamily:'Poppins-Regular',marginVertical:5}}>31th Dec</Text>        
        <TouchableOpacity>
          <FontAwesome name="chevron-right" size={20} color={'rgba(0, 0, 0, 0.60)'} style={{justifyContent:'center',alignItems:'center',marginVertical:8,marginRight:8}}/>
        </TouchableOpacity>                    
